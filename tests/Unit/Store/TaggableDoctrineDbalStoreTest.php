...
final class TaggableDoctrineDbalStoreTest extends TestCase
{
    public function testLoadWithNoEvents(): void
    {
        ...
        $result->expects($this->once())->method('iterateAssociative')->willReturn(new EmptyIterator());

        $connection->expects($this->once())->method('executeQuery')->with('SELECT * FROM event_store WHERE (stream = :stream_0) AND (playhead > :from_playhead) AND (archived = :archived) ORDER BY id ASC', [
            'stream_0' => 'profile-1',
            'from_playhead' => 0,
            'archived' => false,
        ...
        $connection->expects($this->exactly(3))->method('getDatabasePlatform')->willReturn($abstractPlatform);
        $queryBuilder = new QueryBuilder($connection);
        $connection->expects($this->once())->method('createQueryBuilder')->willReturn($queryBuilder);
        $connection->expects($this->once())->method('createExpressionBuilder')->willReturn(new ExpressionBuilder($connection));
    ...
    public function testLoadWithLimit(): void
    {
        ...
        $connection->expects($this->once())->method('executeQuery')->with('SELECT * FROM event_store WHERE (stream = :stream_0) AND (playhead > :from_playhead) AND (archived = :archived) ORDER BY id ASC LIMIT 10', [
            'stream_0' => 'profile-1',
            'from_playhead' => 0,
            'archived' => false,
        ], $this->isArray())->willReturn($result);
    ...
    public function testLoadWithOffset(): void
    {
        ...
        $connection->expects($this->once())->method('executeQuery')->with('SELECT * FROM event_store WHERE (stream = :stream_0) AND (playhead > :from_playhead) AND (archived = :archived) ORDER BY id ASC OFFSET 5', [
            'stream_0' => 'profile-1',
            'from_playhead' => 0,
            'archived' => false,
        ], $this->isArray())->willReturn($result);
    ...
    public function testLoadWithIndex(): void
    {
        ...
        $connection->expects($this->once())->method('executeQuery')->with('SELECT * FROM event_store WHERE (stream = :stream_0) AND (playhead > :from_playhead) AND (id > :from_index) AND (archived = :archived) ORDER BY id ASC', [
            'stream_0' => 'profile-1',
            'from_playhead' => 0,
            'archived' => false,
            'from_index' => 1,
    ...
    public function testLoadWithLike(): void
    {
        ...
        $connection->expects($this->once())->method('executeQuery')->with('SELECT * FROM event_store WHERE (stream LIKE :stream_0) AND (playhead > :from_playhead) AND (archived = :archived) ORDER BY id ASC', [
            'stream_0' => 'profile-%',
            'from_playhead' => 0,
            'archived' => false,
        ], $this->isArray())->willReturn($result);
    ...
    public function testLoadWithLikeAll(): void
    {
        ...
        $connection->expects($this->once())->method('executeQuery')->with('SELECT * FROM event_store WHERE (playhead > :from_playhead) AND (archived = :archived) ORDER BY id ASC', [
            'from_playhead' => 0,
            'archived' => false,
        ], $this->isArray())->willReturn($result);
    ...
    public function testLoadMultipleStream(): void
    {
        ...
        $connection->expects($this->once())->method('executeQuery')->with('SELECT * FROM event_store WHERE ((stream LIKE :stream_0) OR (stream = :stream_1)) AND (playhead > :from_playhead) AND (archived = :archived) ORDER BY id ASC', [
            'stream_0' => 'profile-%',
            'stream_1' => 'foo',
            'from_playhead' => 0,
            'archived' => false,
    ...
    public function testLoadWithOneEvent(): void
    {
        ...
        $eventSerializer = $this->createMock(EventSerializer::class);
        $eventSerializer->expects($this->once())->method('deserialize')->with(new SerializedEvent('profile.created', '{"profileId": "1", "email": "s"}'))->willReturn(new ProfileCreated(ProfileId::fromString('1'), Email::fromString('s')));
    ...
    public function testLoadWithTwoEvents(): void
    {
        ...
        $headersSerializer = $this->createMock(HeadersSerializer::class);
        $headersSerializer->expects($this->exactly(2))->method('deserialize')->with('[]')->willReturn([]);
    ...
    public function testSaveWithOneEvent(): void
    {
        ...
        $mockedConnection->expects($this->once())->method('getDatabasePlatform')->willReturn(new SQLitePlatform());
        $mockedConnection->expects($this->once())->method('transactional')->with($this->isInstanceOf(Closure::class))->willReturnCallback(
            static fn (Closure $closure): mixed => $closure(),
        );

        $mockedConnection->expects($this->once())->method('executeStatement')->with("INSERT INTO event_store (stream, playhead, event_id, event_name, event_payload, tags, recorded_on, archived, custom_headers) VALUES\n(?, ?, ?, ?, ?, ?, ?, ?, ?)", ['profile-1', 1, '1', 'profile_created', '', [], $recordedOn, false, '[]'], [
    ...
    public function testSaveWithThousandEvents(): void
    {
        ...
        $headersSerializer = $this->createMock(HeadersSerializer::class);
        $headersSerializer->expects($this->exactly(10000))->method('serialize')->with([])->willReturn('[]');
    ...
    public function testSaveWithCustomHeaders(): void
    {
        ...
        $headersSerializer = $this->createMock(HeadersSerializer::class);
        $headersSerializer->expects($this->once())->method('serialize')->with($customHeaders)->willReturn('{foo: "foo", baz: "baz"}');
    ...
    {
        $connection = $this->createMock(Connection::class);
        $connection->expects($this->once())->method('fetchOne')->with('SELECT COUNT(*) FROM event_store WHERE (stream = :stream_0) AND (playhead > :from_playhead) AND (archived = :archived)', [
            'stream_0' => 'profile-1',
            'from_playhead' => 0,
            'archived' => false,
        ...
        $connection->expects($this->exactly(2))->method('getDatabasePlatform')->willReturn($abstractPlatform);
    ...
    {
        $connection = $this->createMock(Connection::class);
        $connection->expects($this->once())->method('getDatabasePlatform')->willReturn($this->createMock(AbstractPlatform::class));
