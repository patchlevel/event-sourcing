...
class DateTimeNormalizerTest extends TestCase
{
    ...
    public function testNormalizeWithNotImmutableValue(): void
    {
        $normalizer = new DateTimeNormalizer(immutable: false);
    ...
    public function testDenormalizeWithNotImmutableValue(): void
    {
        $normalizer = new DateTimeNormalizer(immutable: false);
