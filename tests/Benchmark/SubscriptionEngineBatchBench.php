...
use Patchlevel\EventSourcing\Tests\Benchmark\BasicImplementation\Projection\BatchProfileProjector;
use Patchlevel\EventSourcing\Tests\DbalManager;
use PhpBench\Attributes as Bench;

#[Bench\BeforeMethods('setUp')]
final class SubscriptionEngineBatchBench
{
    private Store $store;
    ...
    public function setUp(): void
    {
        ...
        $this->subscriptionEngine = new DefaultSubscriptionEngine(
            ...
            new MetadataSubscriberAccessorRepository(
                [
                    new BatchProfileProjector($connection),
